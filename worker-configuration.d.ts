...
interface CloudflareBindings extends Cloudflare.Env {
  ANKISUB_BUCKET: R2Bucket; // R2 bucket for SRT uploads
  ANKISUB_QUEUE: Queue; // Queue for object-create events
  ANKISUB_DB: D1Database; // D1 database binding
  GEMINI_API_KEY: string; // Secret for Gemini/AI
  GEMINI_API_MODEL: string; // Secret for Gemini/AI
}
